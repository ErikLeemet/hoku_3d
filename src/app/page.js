...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div
        id="home"
        className="relative responsive h-screen box-border flex flex-col mt-0 mr-0 mb-0 ml-0 inline-[0px] items-center justify-center">
          ...
          <div className="hero-content p-0">
            <div className="max-w-md lg:max-w-[1000px] flex flex-col items-center justify-center">
              ...
              <div className="gap-5 w-full flex justify-center">
                <button className="btn btn-secondary min-w-[7.5rem] text-xl pb-2 lg:max-w-[11.25rem] min-h-[50px] flex-auto border-0 text-primary font-['thedusCLR'] duration-300 ease-in-out hover:bg-primary hover:text-secondary hover:border-2 hover:border-secondary">
                  teenused
                </button>
                <button className="btn btn-secondary min-w-[7.5rem] text-xl pb-2 lg:max-w-[11.25rem] min-h-[50px] flex-auto border-0 text-primary font-['thedusCLR'] duration-300 ease-in-out hover:bg-primary hover:text-secondary hover:border-2 hover:border-secondary">
                  kontakt
              ...
              <svg
                ...
                viewBox="0 0 195 886"
                fill="currentColor"
                className="absolute top-0 right-5 z-[-10] fill-accent dark:fill-accent rotate-90 opacity-75">
                <path
                  opacity="0.5"
                  fillRule="evenodd"
                  clipRule="evenodd"
