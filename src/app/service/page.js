...
const Service = () => {
  return (
    <div className="h-[1200px] xl:h-[800px] flex relative flex-col items-center justify-center bg-base-100">
      ...
      <div className="invisible xl:visible w-44 md:w-[400px] h-[60px] bottom-0 absolute rounded-t-[30px] bg-base-100">
