...
function Navbar() {
  ...
  return (
    <nav className={`responsive rounded-lg h-[1.5] box-border py-[0.5] px-[1.25rem] flex flex-none items-center font-['thedusCLR'] z-10 sticky top-0 ${scrolled ? "bg-primary/30 backdrop-blur-lg shadow-md" : "bg-transparent"}`}>
      <div className="w-full flex">
        <svg
          ...
          viewBox="0 0 60 38"
          fill="currentColor"
          className="w-8 h-8 sm:w-10 sm:h-10 lg:w-14 fill-secondary"
        >
