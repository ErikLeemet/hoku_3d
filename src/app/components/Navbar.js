...
function Navbar() {
  ...
  useEffect(() => {
    ...
    if (mediaQuery.addEventListener) {
      ...
      mediaQuery.addListener(handlePrefersChange);
    }
    ...
    return () => {
      if (mediaQuery.removeEventListener) {
        ...
        mediaQuery.removeListener(handlePrefersChange);
      }
    };
  }, []);
  ...
  const links = [
    { href: "home", label: "Avaleht" },
    { href: "about", label: "Meist" },
    { href: "services", label: "Teenused" },
    { href: "gallery", label: "Galerii" },
    { href: "plastic", label: "Plastik" },
