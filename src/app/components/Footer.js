      ...
      <footer className="flex flex-col w-full mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row md:justify-between md:px-6 items-center border-b-2 border-neutral pb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <a className="text-lg font-mono ">info@hoku3d.com</a>
          </div>
        </div>
        <div className="flex flex-col md:flex-row md:justify-between md:px-6 pb-2 items-center">
          ...
          <p className="flex items-center font-['thedusCLR'] pt-2 text-2xl text-neutral-600">
            © {new Date().getFullYear()} Hoku 3D. Kõik õigused kaitstud.
          </p>
        </div>
      </footer>
    </div>
