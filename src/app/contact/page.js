...
const contact = () => {
  return (
    <div
      id="contact"
      className="flex flex-col justify-center items-center w-full min-h-screen py-8 sm:py-10 lg:py-12 px-4 sm:px-6 lg:px-8 bg-surface-2"
    >
      <div className="responsive max-w-4xl w-full rounded-[2rem] border border-panel bg-panel p-6 sm:p-8 lg:p-10 shadow-[0_40px_120px_-80px_rgba(15,23,42,0.15)]">
        <h2 className="text-3xl sm:text-4xl font-[thedusWLB] text-accent mb-3 sm:mb-4 uppercase tracking-wider">
          Võtke meiega ühendust
        </h2>
        <p className="mb-6 sm:mb-8 text-base sm:text-lg font-['thedusCLR'] text-muted">
          Kui sul tekib küsimusi või soovid tellimusest teavet, kirjuta meile
          julgelt. Aitame suuisna kiidumagi!
        </p>
